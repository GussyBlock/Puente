...
contract loteria {
    ...
    //Numero de voletos por persona
    mapping(address => uint)num_de_boletos;
    // Numero aleatorio 
    uint randNonce = 0;
    // Boletos generados 
    uint [] public boletos_comprados;
    // Eventos 
    ...
    function CompraBoleto(uint _boletos) public {
        ...
        */
        ...
        num_de_boletos[msg.sender] += _boletos;
        /*
    ...
    // Visualizar el numero de boletos que tiene una persona
    function NumDeBoletos(address _propietario) public view returns (uint){
        return num_de_boletos[_propietario];
    }
